//
//  DecortorPatternTest.h
//  Test
//
//  Created by zhang dekai on 2025/8/15.
...
#ifndef DecortorPatternTest_h
#define DecortorPatternTest_h

int testDecortorPattern(void) {
